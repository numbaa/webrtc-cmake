...
add_library("${WEBRTC_COMPONENT_PREFIX}_rtc_media_base" STATIC
...
add_library("${WEBRTC_COMPONENT_PREFIX}_rtc_audio_video" STATIC
...
add_library("${WEBRTC_COMPONENT_PREFIX}_rtc_media_engine_defaults" STATIC
    "${WEBRTC_MEDIA_DIR}/engine/webrtc_media_engine_defaults.cc"
    "${WEBRTC_MEDIA_DIR}/engine/webrtc_media_engine_defaults.h"
}

add_library("${WEBRTC_COMPONENT_PREFIX}_rtc_data" STATIC
...
add_library("${WEBRTC_COMPONENT_PREFIX}_media" STATIC

)

add_library(webrtc::media ALIAS "${WEBRTC_COMPONENT_PREFIX}_media")